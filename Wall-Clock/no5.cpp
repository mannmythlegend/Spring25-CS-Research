...
int main() {
    ...
    for (int power = 10; power <= 20; ++power) {
        ...
        cout << "Power " << power << " - Average execution time: " << (total / durations.size()) << " microseconds" << endl;
    
        int passed = count(isCorrect.begin(), isCorrect.end(), true);
        cout << "Correctness: " << passed << "/100 passed for power = " << power << "\n\n";
    }

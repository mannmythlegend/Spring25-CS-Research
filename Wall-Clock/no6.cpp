...
public:
   ...
   int select(int s) {
    ...
    void objswap(OnlineSelectionSearch& oss, int i, int j) {
        int ai = oss.getA(i), aj = oss.getA(j);
        if (ai > aj) {
            oss.setA(i, aj);
            oss.setA(j, ai);
        }
    }
    void sort5(OnlineSelectionSearch& oss, int i) {
        int a = i - 5;
        int b = i - 4;
        int c = i - 3;
        int d = i - 2;
        ...
        if (oss.getA(a) > oss.getA(b)) objswap(oss, a, b); // 1
        if (oss.getA(d) > oss.getA(e)) objswap(oss, d, e); // 2
        if (oss.getA(c) > oss.getA(e)) objswap(oss, c, e); // 3
        if (oss.getA(c) > oss.getA(d)) objswap(oss, c, d); // 4
        if (oss.getA(a) > oss.getA(d)) objswap(oss, a, d); // 5
        if (oss.getA(a) > oss.getA(c)) objswap(oss, a, c); // 6
        if (oss.getA(b) > oss.getA(e)) objswap(oss, b, e); // 7
    }
        ...
        for (int i = 0; i < array.size(); i++) {
            if (oss.getV(i) == 0) {
                ...
                if (counter == 2) {
                    ...
                    if (oss.getA(i - 4) > oss.getA(i - 3)) {
                        int temp = oss.getA(i - 4);
                        oss.setA(i - 4, oss.getA(i - 3));
                        oss.setA(i - 3, temp);
                    }
                    if (oss.getA(i - 2) > oss.getA(i - 1)) {
                        int temp = oss.getA(i - 2);
                    ...
                    if (oss.getA(i - 4) > oss.getA(i - 2)) {
                        int temp = oss.getA(i - 4);
                        oss.setA(i - 4, oss.getA(i - 2));
                        oss.setA(i - 2, temp);
                    }
                    if (oss.getA(i - 3) > oss.getA(i - 1)) {
                        int temp = oss.getA(i - 3);
                        oss.setA(i - 3, oss.getA(i - 1));
                        oss.setA(i - 1, temp);
                    }
                    if (oss.getA(i - 3) > oss.getA(i - 2)) {
                        int temp = oss.getA(i - 3);
                    ...
                    /*if (oss.getA(i - 5) > oss.getA(i - 4)) {
                        int temp = oss.getA(i - 5);
                        oss.setA(i - 5, oss.getA(i - 4));
                        oss.setA(i - 4, temp);
                    }
                    if (oss.getA(i - 3) > oss.getA(i - 2)) {
                        int temp = oss.getA(i - 3);
                    ...
                    if (oss.getA(i - 5) > oss.getA(i - 3)) {
                        int temp = oss.getA(i - 5);
                        oss.setA(i - 5, oss.getA(i - 3));
                        oss.setA(i - 3, temp);
                    ...
                    // Insertion of i-1 into sorted part
                    if (oss.getA(i - 1) < oss.getA(i - 3)) {
                        if (oss.getA(i - 1) < oss.getA(i - 5)) {  // FIXED!
                            int temp = oss.getA(i - 1);
                            oss.setA(i - 1, oss.getA(i - 5));
                            oss.setA(i - 5, temp);
                    
                            temp = oss.getA(i - 1);
                            oss.setA(i - 1, oss.getA(i - 4));
                            oss.setA(i - 4, temp);
                    
                            temp = oss.getA(i - 1);
                            oss.setA(i - 1, oss.getA(i - 3));
                            oss.setA(i - 3, temp);
                    ...
                    } else if (oss.getA(i - 1) < oss.getA(i - 2)) {
                        int temp = oss.getA(i - 1);
                        oss.setA(i - 1, oss.getA(i - 2));
                        oss.setA(i - 2, temp);
                    }*/

                    int a[] = {oss.getA(i - 5), oss.getA(i - 4), oss.getA(i - 3), oss.getA(i - 2), oss.getA(i - 1)};
                    std::sort(a, a + 5);
                    oss.setA(i - 5, a[0]);
                    oss.setA(i - 4, a[1]);
                    oss.setA(i - 3, a[2]);
